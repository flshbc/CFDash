...
%% solving
[phi,A,Q,phi_diff,end_steps,end_time] = unsteady_eq_1d(rho,u_test,L,gamma,N_test, ...
    phi_0,phi_L,phi_ini, ...
    'linear-2nd','linear', ...
...
%% solver for 1D unsteady scalar transport equation
% Associated file: unsteady_transport_FVM_1d.m
% reuse the steady-state solver for construction of const. A,Q
function [phi,A,Q,phi_diff,end_step,end_time] = unsteady_eq_1d(rho,u,L,gamma,N,phi_0,phi_L,phi_ini,bc,interp,iter_max,converge_crit,dt,theta)
